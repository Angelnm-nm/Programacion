...
public class RepasoUtilidades {
    public static void main(String[] args) {
        ...
        Arrays.sort(stockArray);
        Arrays.binarySearch(stockArray , "LAV-01");
        ...
        Collections.addAll(listaProductos,
                new Producto("MICRO-04","pedro", 150),
                new Producto("TAB-05","jimenez" ,300));
        ...
        Collections.max(listaProductos);
        Collections.min(listaProductos);
